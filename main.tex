...
While it is possible to directly compute the value of equation \textcolor{red}{[cite the equation above]} via matrix algebra, this is computationally expensive.
Instead, \texttt{contraband} saves us time by using an alternative mathematical formulation \textcolor{red}{[cite Mitov's paper]} and a dynamic programming algorithm.
The details do not matter for this tutorial, but it is important to re-write equation \textcolor{red}{[cite equation above]} as:
...
These are \textcolor{red}{[list the clock parameters here]}.
