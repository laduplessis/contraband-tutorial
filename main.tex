...
In the ''Priors" panel, we select "Fossilized Birth Death Model" \citep{gavryushkina2014} as the tree prior and leave the rest of the parameters at their default prior distributions.
...
\emph{precooked-runs} folder. \textcolor{red}{\textbf{ Precooked runs don't exist!}}
...
\section{Practical  Part \uppercase\expandafter{\romannumeral 4}: Parameter and State inference using combined data with the Brownian motion model combined with a shrinkage method}
...
\textcolor{red}{\textbf{ SECTION INCOMPLETE?}}
...
\begin{figure}[!htbp]
    ...
    \caption{Setting site models for molecular sequences.}
    \label{fig:example10}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \caption{Set site models for discrete characters.}
    \label{fig:example11}
\end{figure}
...
% Comment out incomplete section? 
