...
%\end{figure}
%
%\item Next, we can have a look at the inferred effective population sizes. New
...
Use the logged trees in the file  \lstinline!carnivora_27.trees! as \textbf{Input Tree File}. Name output file \lstinline!carnivora_27_mcc.tree!.
...
\item Analyse and compare the MCC trees
\end{itemize}
